...
// ── Preview table columns (from the screenshot) ──────────────────────────────
...
const QTYS = [35.442802,49.546396,19.975629,5.955925,79.424372,7.965763,6.318231,10.107147,34.771812,94.977434,18.532907,22.823695,3.097786,1.852907,27.514408,45.110959,2.719074];
const SOLD_TO = ["UGEP","UGEP","UGEP","TRICESIMO","TRICESIMO","UGEP","UGEP","UGEP","UGEP","UGEP","UGEP","UGEP","UGEP","UGEP","UGEP","TRICESIMO","UGEP","TRICESIMO"];
const UNITS = ["PC","PC","PC","PC","PC","EA","PC","PC","PC","PC","PC","PC","PC","PC","PC","PC","EA","PC"];
...
const SYNTHETIC_LOCATIONS = ["UGEP","TRICESIMO","BERLIN","PARIS","LONDON","MADRID","ROME","OSLO","VIENNA","WARSAW"];
const SYNTHETIC_BATCHES   = ["BATCH-001","BATCH-002","BATCH-003","","BATCH-004","","BATCH-005","BATCH-006","","BATCH-007"];
