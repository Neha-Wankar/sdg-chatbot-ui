      ...
      <section className="chat-workspace flex-1 flex flex-col min-h-0">
        <div ref={chatScrollRef} className="chat-messages flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
          <div className="max-w-250 w-full mx-auto px-4 md:px-8 py-5 md:py-7">
            ...
            {loading && (
              <div className="flex gap-2.5 items-start my-2.5" ref={latestResponseRef}>
                <div className="ai-bubble-avatar w-7 h-7 shrink-0 rounded-xl flex items-center justify-center">
                ...
                <div className="ai-message-bubble px-3.5 py-2 text-xs text-gray-500 flex items-center gap-2.5">
