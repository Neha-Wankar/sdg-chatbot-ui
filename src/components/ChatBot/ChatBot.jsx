...
export default function ChatBot({ messages, setMessages, conversationId }) {
  ...
  return (
    <main className="flex-1 min-w-0 flex flex-col bg-gray-50">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 px-5 py-3.5 flex justify-between items-center shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-gray-900 mb-0">Synthetic Data Generator</h1>
            <p className="text-xs text-gray-500">Nestle business requirement intelligence</p>
          </div>
        </div>
      ...
      <section className="chat-workspace flex-1 flex flex-col min-h-0">
        <div className="chat-messages flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
          <div className="max-w-[980px] w-full mx-auto px-3 md:px-6 py-4 md:py-6">
            ...
            {loading && (
              <div className="flex gap-2 items-start my-3" ref={latestResponseRef}>
                <div
                ...
                <div className="flex flex-wrap gap-2">
                  {suggestions.map((suggestion) => (
                    <button
                      ...
                      className="suggestion-chip flex items-center gap-2 px-3 py-2 text-sm text-gray-700 bg-white border border-gray-200 rounded-xl text-left transition hover:border-blue-400 hover:text-blue-700 hover:bg-blue-50"
                    >
        ...
        <div className="shrink-0 px-3 md:px-6 pb-4">
          ...
          />
          <p className="text-center text-xs text-gray-400 mt-2">Press Enter to send · Shift + Enter for a new line</p>
          <p className="text-center text-xs text-gray-400 mb-1">Scenario Mapping Assistant • Use approved business information only.</p>
        </div>
      </section>
    </main>
  );
